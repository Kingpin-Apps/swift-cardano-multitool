...
extension ProtectMainCommand {
    ...
    struct Encrypt: AsyncParsableCommand {
        ...
        mutating func run() async throws {
            ...
            print(noora.format(
                "SKEY-File that will be encrypted: \(.path(try .init(validating: fileName.string)))\n"
            ))
            ...
            noora.success(.alert("Encrypted SKEY-File saved successfully to disc at \(.path(try .init(validating: fileName.string)))."))
