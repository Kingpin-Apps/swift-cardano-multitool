...
extension CommitteeColdCredential: @retroactive _SendableMetatype {}
extension CommitteeColdCredential: @retroactive ExpressibleByArgument {
    public init?(argument: String) {
        let trimmed = argument.trimmingCharacters(in: .whitespacesAndNewlines)

        // Try Bech32 first (cc_cold...)
