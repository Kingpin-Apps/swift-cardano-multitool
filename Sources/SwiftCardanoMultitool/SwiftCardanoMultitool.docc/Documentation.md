...
- **Chain context** — obtain a live `ChainContext` for querying UTxOs, protocol parameters, and chain state via Blockfrost, Koios, Ogmios, a local Yaci DevKit devnet, or a local node socket.
