...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-core.git", from: "0.4.11"),
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-chain.git", from: "0.6.1"),
        ...
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-txbuilder.git", from: "1.0.2"),
