...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-chain.git", from: "0.2.6"),
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-txbuilder.git", from: "0.2.4"),
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-utils.git", from: "0.3.0"),
