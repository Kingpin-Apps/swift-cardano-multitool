...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-chain.git", from: "0.1.24"),
        .package(url: "https://github.com/Kingpin-Apps/swift-cardano-utils.git", from: "0.1.12"),
